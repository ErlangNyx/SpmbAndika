<x-filament::page>
    ...
    <button class="filament-button bg-primary-600 text-white py-1 px-4" wire:click="buatBilling( {{$biaya['data']['id']}}, '{{$biaya['data']['nama_biaya']}}', {{$biaya['data']['jumlah']}})">
        Buat E-Billing
    </button>
    @else
    ...
    @endif
    @else
    Maaf ada kesalahan: <b>{{ $biaya['pesan'] }}</b>
    @endif
</x-filament::page>